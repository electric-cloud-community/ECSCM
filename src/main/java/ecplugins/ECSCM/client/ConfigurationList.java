 ...
 * This component is used in Administration->Source Control
 */
    ...
    extends ListBase
{
    ...
    {
        super("scmList", "Source Control Configurations", "All Configurations");
    ...
    @Override protected void load()
    {
        ...
        ScmConfigListLoader loader = new ScmConfigListLoader(m_configList, this,
                new ChainedCallback() {
    ...
    private void deleteConfiguration(String configName)
    {
        ...
        request.setProjectName("/plugins/ECSCM/project");
    ...
    private void loadList()
    {
        ...
        for (String configName : m_configList.getConfigNames()) {
            ...
            // Description
            Label configDescLabel = new Label(m_configList.getConfigDescription(
                        configName));

            // Plugin name
            String configPlugin      = m_configList.getConfigPlugin(configName);
            Label  configPluginLabel = new Label(configPlugin);
            ...
            urlBuilder.setParameter("configPlugin", configPlugin);
            urlBuilder.setParameter("redirectTo",
                createRedirectUrl().buildString());
            ...
            DialogClickHandler dch              = new DialogClickHandler(
                    new DeleteConfirmationDialog(configName,
                        "Are you sure you want to delete SCM configuration '"
                            + configName + "'?") {
            ...
            listTable.addRow(configNameLabel, configDescLabel,
                configPluginLabel, actions);
        }
